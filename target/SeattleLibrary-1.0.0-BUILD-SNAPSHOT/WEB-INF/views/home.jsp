...
<body class="wrapper">
    ...
    <main>
        ...
        <a href="<%=request.getContextPath()%>/sortAuthor" class="btn_add_book">著者名順</a> <a href="<%=request.getContextPath()%>/sortPublishDate" class="btn_add_book">出版日最新順</a>--> <a href="<%=request.getContextPath()%>/sortFavorite" class="btn_add_book">お気に入り</a>
